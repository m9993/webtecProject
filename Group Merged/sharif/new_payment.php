        ...
        <div class="container-fluid">
          ...
          <form method="POST"  action="insertpayment.php" name="datavalid" onsubmit="return validateForm()">
            ...
            <div class="form-group row">
              ...
              <div class="col-4">
                <input type="text" class="form-control form-control-sm" name="p_incomeTax" value="" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-4">
                <input type="text" class="form-control form-control-sm" name="p_others" value="" required>
