        ...
        <div class="row">
            ...
            <div class="col-10 bg-transparent">
                <div class="container-fluid">
                    ...
                    <form method="POST" action="updateworkingtime.php" name="datavalid"
                        onsubmit="return validateForm()">
                        <div class="form-group row">
                            <label for="t_id" class="col-sm-2 col-form-label">t_id</label>
                            <div class="col-4">
                                <input type="text" class="form-control form-control-sm" name="t_id"
                                    value=<?php echo $_GET['t_id'] ?> readonly required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                <input type="text" class="form-control form-control-sm" name="t_hour"
                                    value=<?php echo $_GET['t_hour'] ?> required>
