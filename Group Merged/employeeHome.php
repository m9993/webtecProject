...
<html lang="en">
  ...
  <body>
	...
	<div class="container text-center mt-5" id="catagory">
        ...
        <button type="button" name="users" onclick="window.location.href='mahmudul/edit.php'" class="btn btn-warning font-weight-bold shadow m-3 m-sm-4" style="width: 10rem; height: 10rem;"><br>Employee Self Update</button>


        <button type="button" onclick="window.location.href='sharif/workingtime.php'" class="btn btn-danger font-weight-bold shadow m-3 m-sm-4" style="width: 10rem; height: 10rem;"><br>Working time</button>
