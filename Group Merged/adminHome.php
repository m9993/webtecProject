...
<html lang="en">
  ...
  <body>
	...
	<div class="container text-center mt-5" id="catagory">
        ...
        <button type="button" name="workingTime" onclick="window.location.href='rumi/admin_workingtime.php'" class="btn btn-danger font-weight-bold shadow m-3 m-sm-4" style="width: 10rem; height: 10rem;"><i class="fas fa-user-clock"></i><br>Working Time</button>

        <button type="button" name="payment" onclick="window.location.href='rumi/admin_payment.php'" class="btn btn-info font-weight-bold shadow m-3 m-sm-4" style="width: 10rem; height: 10rem;"><i class="fab fa-amazon-pay"></i><br>Payment</button>
